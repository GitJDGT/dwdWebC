            ...
            <div class="max-w-8xl w-full mx-auto items-center flex justify-center h-screen">
                ...
                <div class="bg-slate-800 rounded-lg p-6 space-y-5 w-3/4">
                    ...
                    <form action="" method="post" class="flex flex-col">
                        ...
                        <label for="email" class="text-lg text-white mb-1 font-semibold">Password</label>
                        <input type="password" name="password" id="password" class="p-2 rounded bg-slate-900 border border-slate-700 mb-4">

                        <label for="email" class="text-lg text-white mb-1 font-semibold">Device</label>
                        ...
                        <input type="button" value="Log In" id="loginBtn" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded hover:cursor-pointer duration-150 mb-2">
